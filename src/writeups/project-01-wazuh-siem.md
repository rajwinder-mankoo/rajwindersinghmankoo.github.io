...
Deployed the first agent on `c0mpl1cated-lab-cloud` (an existing OptiPlex already running real workloads — better first target than an idle box with nothing to log). Install went clean. Dashboard said **"Never connected."**
