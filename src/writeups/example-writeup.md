...
This file exists to prove the writeups pipeline works end to end: front matter parses, the layout renders, and the collection picks it up (unless `draft: true
permalink: false`, as here).
...
4. Remove `draft: true
permalink: false` (or don't add it) when ready to publish
