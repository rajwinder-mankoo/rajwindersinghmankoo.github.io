...
This file exists to prove the writeups pipeline works end to end — front matter parses, the layout renders, the collection picks it up (unless `draft: true`, as here).
